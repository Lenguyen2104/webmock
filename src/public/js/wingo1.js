...
function showSupportBet(x) {
  $.ajax({
    type: "POST",
    url: "/api/webapi/action/top100WingoStatistics",
    data: {
      typeid:1
    },
    dataType: "json",
    success: function (response) {
      ...
      const SoKyChuaXo= response.so_ky_chua_so.map((soKyChuaXo) => {
        return `<div data-v-a9660e98="" class="ul"><div data-v-a9660e98="">${soKyChuaXo}</div></div>`;
      });
      const BinhQuanSoKy= response.binh_quan_so_ky.map((binhquan) => {
        return `<div data-v-a9660e98="" class="ul"><div data-v-a9660e98="">${binhquan}</div></div>`;
      });
      const TanSoXuatHien= response.tan_so_xuat_hien.map((tanso) => {
        return `<div data-v-a9660e98="" class="ul"><div data-v-a9660e98="">${tanso}</div></div>`;
      });
      const SoKyLienTiepToiDa = response.so_ky_lien_tiep_toi_da.map((soky) => {
        return `<div data-v-a9660e98="" class="ul"><div data-v-a9660e98="">${soky}</div></div>`;
      });
      $(`.game-list .con-box:eq(${x}) .supportBet .soKyChuaXo`).html(SoKyChuaXo.join(''));
      $(`.game-list .con-box:eq(${x}) .supportBet .binhQuanSoKy`).html(BinhQuanSoKy.join(''));
      $(`.game-list .con-box:eq(${x}) .supportBet .tanSoXuatHien`).html(TanSoXuatHien.join(''));
      $(`.game-list .con-box:eq(${x}) .supportBet .soKyLienTiepToiDa`).html(SoKyLienTiepToiDa.join(''));
    },
  });
  let reward= [
    `<div data-v-a9660e98="" class="li reward"><div data-v-a9660e98="">0</div></div>`,
    `<div data-v-a9660e98="" class="li reward"><div data-v-a9660e98="">1</div></div>`,
    `<div data-v-a9660e98="" class="li reward"><div data-v-a9660e98="">2</div></div>`,
    `<div data-v-a9660e98="" class="li reward"><div data-v-a9660e98="">3</div></div>`,
    `<div data-v-a9660e98="" class="li reward"><div data-v-a9660e98="">4</div></div>`,
    `<div data-v-a9660e98="" class="li reward"><div data-v-a9660e98="">5</div></div>`,
    `<div data-v-a9660e98="" class="li reward"><div data-v-a9660e98="">6</div></div>`,
    `<div data-v-a9660e98="" class="li reward"><div data-v-a9660e98="">7</div></div>`,
    `<div data-v-a9660e98="" class="li reward"><div data-v-a9660e98="">8</div></div>`,
    `<div data-v-a9660e98="" class="li reward"><div data-v-a9660e98="">9</div></div>`
  ];
  $(`.game-list .con-box:eq(${x}) .supportBet .reward`).html(reward);
}
                                        ...
                                        ${
                                          list_orders.status == 1
                                            ...
                                            ? '<span data-v-a9660e98="" class="fail"> - ' +
                                              ...
                                              "</span>"
                                            : list_orders.status == 0
                                                      ? '<button data-v-a9660e98="" style="font-weight:normal!important;font-size: 12px">' +
                                                      'Chờ kết quả' +
                                                      "</button>"
                                             : ""
                                        }
  ...
  function cownDownTimer() {
    ...
    setInterval(() => {
      ...
      if (seconds1 == 0 && seconds2 <= 5) {
        let check_volume = localStorage.getItem('volume');
        if (clicked && check_volume === 'on') {
          console.log("AM THANH KEU NAY!")
          playAudio1();
        }
      }
